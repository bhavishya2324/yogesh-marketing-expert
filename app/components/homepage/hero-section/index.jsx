...
function HeroSection() {
  return (
    <section className="relative flex  items-center justify-between py-8 lg:py-12">
      ...
      <div className="grid  grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-2 ">
        <div className="order-2 lg:order-1  flex flex-col items-start justify-center p-2  pb-4 md:pb-10 lg:pt-10">
          <h1 className="text-3xl font-bold leading-15 py-2 text-white md:font-extrabold lg:text-[2.6rem] lg:leading-[3.5rem]">
            Unlock Growth with{" "}
          ...
          <div className="flex items-center ">
            ...
            <Link
              href="https://calendly.com/noxizfromfuture"
              className="bg-gradient-to-r mx-4 to-pink-500 from-violet-600 p-[1px] rounded-full transition-all duration-300 hover:from-pink-500 hover:to-violet-600"
            >
        ...
        <div className="order-1 pt-5px    relative rounded-lg  bg-gradient-to-r to-[#0a0d37]">
          ...
          <div className="overflow-hidden bg-[linear-gradient(90deg,#281e57_0%,#0d1224_100%)] shadow-2xl rounded-lg border border-[#1a1443] border-t-[2px] border-indigo-900 px-2   lg:px-24 py-3  lg:py-4 ">
            <Image
